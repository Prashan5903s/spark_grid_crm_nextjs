      ...
      >
        ...
        <MenuSection label="App Pages">
          ...
          {permissArray?.isCompany && (
            <MenuItem key="mail_log_data" href={`/${locale}/apps/mail/log`} icon={<i className="tabler-mail-opened" />}>Mail Log</MenuItem>
          )}
          {permissArray?.isCompany && (
          ...
          {permissArray?.isSuperAdmin && (
            <MenuItem key="notification_listing" href={`/${locale}/apps/admin/templates`} icon={<i className="tabler-notification" />}>Templates</MenuItem>
          ...
          {((permissArray?.isCompany && permissArray?.hasLabelPermission) || permissArray?.isSuperAdmin) && (
            <SubMenu label="Settings" icon={<i className="tabler-settings" />}>
              ...
              {permissArray?.isCompany && (
                <MenuItem href={`/${locale}/apps/templates`}>Templates</MenuItem>
              )}
            </SubMenu>
          )}
        </MenuSection>
